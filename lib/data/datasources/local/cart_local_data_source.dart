...
const CART_ITEMS_LIST = 'CART_ITEMS_LIST';
...
class CartLocalDataSourceImpl implements CartLocalDataSource {
  ...
  Future<List<CartModel>> getCartItems() async {
    final jsonCartItemsList = sharedPreferences.getStringList(CART_ITEMS_LIST);
  ...
  Future<void> addItems(CartModel cartItem) async {
    late List<String> jsonCartItemsList =
        sharedPreferences.getStringList(CART_ITEMS_LIST) ?? [];
    ...
    await sharedPreferences.setStringList(CART_ITEMS_LIST, jsonCartItemsList);
    print('Cart items written to Cache: ${jsonCartItemsList.length}');
  }
  ...
  Future<void> removeItems(int removeItemId) async {
    ...
    if (jsonCartItemsList != null && jsonCartItemsList.isNotEmpty) {
      ...
      await sharedPreferences.setStringList(
          CART_ITEMS_LIST, updatedJsonCartItemsList);
    }
  }
}
